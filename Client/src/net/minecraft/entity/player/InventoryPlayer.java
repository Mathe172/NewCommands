...
public class InventoryPlayer implements IInventory
{
	...
	public int func_174925_a(final Item p_174925_1_, final int p_174925_2_, final int p_174925_3_, final NBTTagCompound p_174925_4_)
	{
		...
		for (var6 = 0; var6 < this.mainInventory.length; ++var6)
		{
			...
			if (var7 != null && (p_174925_1_ == null || var7.getItem() == p_174925_1_) && (p_174925_2_ <= -1 || var7.getMetadata() == p_174925_2_) && (p_174925_4_ == null || NBTBase.compareTags(p_174925_4_, var7.getTagCompound(), true)))
			{
		...
		for (var6 = 0; var6 < this.armorInventory.length; ++var6)
		{
			...
			if (var7 != null && (p_174925_1_ == null || var7.getItem() == p_174925_1_) && (p_174925_2_ <= -1 || var7.getMetadata() == p_174925_2_) && (p_174925_4_ == null || NBTBase.compareTags(p_174925_4_, var7.getTagCompound(), false)))
			{
				var8 = p_174925_3_ <= 0 ? var7.stackSize : Math.min(p_174925_3_ - var5, var7.stackSize);
				var5 += var8;
		...
		if (this.itemStack != null)
		{
			...
			if (p_174925_4_ != null && !NBTBase.compareTags(p_174925_4_, this.itemStack.getTagCompound(), false))
				return var5;
	...
	public int getTotalArmorValue()
	{
		...
		for (final ItemStack element : this.armorInventory)

...
public abstract class Entity implements ICommandSender
{
	...
	public Vec3 func_174824_e(final float p_174824_1_)
	{
		...
		else
		{
			...
			final double var4 = this.prevPosY + (this.posY - this.prevPosY) * p_174824_1_ + this.getEyeHeight();
			final double var6 = this.prevPosZ + (this.posZ - this.prevPosZ) * p_174824_1_;
	...
	public void func_180426_a(final double p_180426_1_, double p_180426_3_, final double p_180426_5_, final float p_180426_7_, final float p_180426_8_, final int p_180426_9_, final boolean p_180426_10_)
	{
		...
		final List var11 = this.worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox().contract(0.03125D, 0.0D, 0.03125D));

...
public class Chunk
{
	...
	{
		final int var4 = this.heightMap[z << 4 | x] & 255;
		int var5 = var4;
		...
		if (var5 != var4)
		{
			...
			if (!this.worldObj.provider.getHasNoSky())
			{
				...
				while (var5 > 0 && var8 > 0)
				{
					...
					final ExtendedBlockStorage var10 = this.storageArrays[var5 >> 4];
	...
	public IBlockState getBlockState(final BlockPos pos)
	{
		if (this.worldObj.getWorldType() == WorldType.DEBUG_WORLD)
		{
			...
			try
			{
				...
				{
					final ExtendedBlockStorage var2 = this.storageArrays[pos.getY() >> 4];
	...
	public void removeTileEntity(final BlockPos pos)
	{
		if (this.isChunkLoaded)
		{
			final TileEntity var2 = (TileEntity) this.chunkTileEntityMap.remove(pos);
	...
	public void onChunkLoad()
	{
		...
		for (final ClassInheratanceMultiMap entityList : this.entityLists)
		{
	...
	public void onChunkUnload()
	{
		...
		final Iterator var1 = this.chunkTileEntityMap.values().iterator();
	...
	{
		int minY = MathHelper.floor_double((boundingBox.minY - 2.0D) / 16.0D);
		int maxY = MathHelper.floor_double((boundingBox.maxY + 2.0D) / 16.0D);
		minY = MathHelper.clamp_int(minY, 0, this.entityLists.length - 1);
		maxY = MathHelper.clamp_int(maxY, 0, this.entityLists.length - 1);
		
		for (int y = minY; y <= maxY; ++y)
			for (final Object entity : this.entityLists[y])
				World.filterEntity((Entity) entity, list, predicate);
	}
	...
	public void func_177414_a(final Entity p_177414_1_, final AxisAlignedBB p_177414_2_, final List p_177414_3_, final Predicate p_177414_4_)
	{
		...
		{
			final Iterator var8 = this.entityLists[var7].iterator();
	...
	public void func_177430_a(final Class p_177430_1_, final AxisAlignedBB p_177430_2_, final List p_177430_3_, final Predicate p_177430_4_)
	{
		...
		for (int var7 = var5; var7 <= var6; ++var7)
		{
			final Iterator var8 = this.entityLists[var7].func_180215_b(p_177430_1_).iterator();
	...
	public void func_150804_b(final boolean p_150804_1_)
	{
		...
		{
			final BlockPos var2 = (BlockPos) this.field_177447_w.poll();
	...
	public void func_177439_a(final byte[] p_177439_1_, final int p_177439_2_, final boolean p_177439_3_)
	{
		...
		if (p_177439_3_)
		{
			...
			final int var10000 = var4 + this.blockBiomeArray.length;
		}
		...
		final Iterator var9 = this.chunkTileEntityMap.values().iterator();

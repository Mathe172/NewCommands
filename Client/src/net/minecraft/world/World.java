...
public abstract class World implements IBlockAccess
{
	...
	/**
	 * is a temporary list of blocks and light values used when updating light levels. Holds up to 32x32x32 blocks (the maximum influence of a light source.) Every element is a packed bit value: 0000000000LLLLzzzzzzyyyyyyxxxxxx. The 4-bit L is a light level used when darkening blocks. 6-bit numbers
	 * x, y and z represent the block's offset from the original block, plus 32 (i.e. value of 31 would mean a -1 offset
	 */
	...
	public int getLightFromNeighborsFor(final EnumSkyBlock type, BlockPos p_175705_2_)
	{
		...
		else
		{
			...
			else if (this.getBlockState(p_175705_2_).getBlock().getUseNeighborBrightness())
			{
				...
				final int var4 = this.getLightFor(type, p_175705_2_.offsetEast());
				final int var5 = this.getLightFor(type, p_175705_2_.offsetWest());
				final int var6 = this.getLightFor(type, p_175705_2_.offsetSouth());
				final int var7 = this.getLightFor(type, p_175705_2_.offsetNorth());
			...
			{
				final Chunk var3 = this.getChunkFromBlockCoords(p_175705_2_);
	...
	public MovingObjectPosition rayTraceBlocks(Vec3 p_147447_1_, final Vec3 p_147447_2_, final boolean p_147447_3_, final boolean p_147447_4_, final boolean p_147447_5_)
	{
		if (!Double.isNaN(p_147447_1_.xCoord) && !Double.isNaN(p_147447_1_.yCoord) && !Double.isNaN(p_147447_1_.zCoord))
		{
			if (!Double.isNaN(p_147447_2_.xCoord) && !Double.isNaN(p_147447_2_.yCoord) && !Double.isNaN(p_147447_2_.zCoord))
			{
				...
				final IBlockState var14 = this.getBlockState(var12);
				...
				while (var42-- >= 0)
				{
					...
					final IBlockState var38 = this.getBlockState(var12);
					...
					if (!p_147447_4_ || var39.getCollisionBoundingBox(this, var12, var38) != null)
						...
						{
							final MovingObjectPosition var40 = var39.collisionRayTrace(this, var12, p_147447_1_, p_147447_2_);
	...
	public int calculateSkylightSubtracted(final float p_72967_1_)
	{
		...
		var3 = (float) (var3 * (1.0D - this.getWeightedThunderStrength(p_72967_1_) * 5.0F / 16.0D));
		var3 = 1.0F - var3;
	...
	public float getSunBrightness(final float p_72971_1_)
	{
		...
		var3 = (float) (var3 * (1.0D - this.getWeightedThunderStrength(p_72971_1_) * 5.0F / 16.0D));
	...
	public Vec3 getSkyColor(final Entity p_72833_1_, final float p_72833_2_)
	{
		...
		{
			var17 = this.lastLightningBolt - p_72833_2_;
	...
	public void updateEntities()
	{
		...
		final Iterator var10 = this.tickableTileEntities.iterator();
		...
		if (!this.addedTileEntityList.isEmpty())
		{
			...
			{
				final TileEntity var14 = (TileEntity) this.addedTileEntityList.get(var12);
	...
	{
		final List var3 = this.getEntitiesWithinAABBExcludingEntity((Entity) null, p_72917_1_);
			...
			for (int var12 = var4; var12 < var5; ++var12)
				for (int var13 = var6; var13 < var7; ++var13)
					for (int var14 = var8; var14 < var9; ++var14)
					{
						...
						{
							final double var18 = var13 + 1 - BlockLiquid.getLiquidHeightPercent(((Integer) var16.getValue(BlockLiquid.LEVEL)).intValue());
		...
		for (int var9 = var3; var9 < var4; ++var9)
			for (int var10 = var5; var10 < var6; ++var10)
				for (int var11 = var7; var11 < var8; ++var11)
				{
					...
					{
						final int var15 = ((Integer) var13.getValue(BlockLiquid.LEVEL)).intValue();
	...
	protected void func_147467_a(final int p_147467_1_, final int p_147467_2_, final Chunk p_147467_3_)
	{
		...
		if (this.ambientTickCountdown == 0 && !this.isRemote)
		{
			...
			{
				final EntityPlayer var10 = this.getClosestPlayer(var5 + 0.5D, var7 + 0.5D, var6 + 0.5D, 8.0D);
	...
	public void filterEntities(final AxisAlignedBB boundingBox, final List<Entity> list, final Predicate<Entity> predicate)
	{
		final double minX = Math.floor((boundingBox.minX - 2.0D) / 16.0D);
		final double maxX = Math.floor((boundingBox.maxX + 2.0D) / 16.0D);
		final double minZ = Math.floor((boundingBox.minZ - 2.0D) / 16.0D);
		final double maxZ = Math.floor((boundingBox.maxZ + 2.0D) / 16.0D);
		
		if ((maxX - minX + 1.0) * (maxZ - minZ + 1.0) < this.chunkProvider.getLoadedChunkCount())
		{
			for (int x = (int) minX; x <= (int) maxX; ++x)
				for (int z = (int) minZ; z <= (int) maxZ; ++z)
					if (this.isChunkLoaded(x, z, true))
						this.getChunkFromChunkCoords(x, z).filterEntities(boundingBox, list, predicate);
		}
		else
			for (final Object entity : this.loadedEntityList)
				filterEntity((Entity) entity, list, predicate);
	}
	
	public static void filterEntity(final Entity entity, final List<Entity> list, final Predicate<Entity> predicate)
	{
	...
	{
		final ArrayList var3 = Lists.newArrayList();
		final Iterator var4 = this.loadedEntityList.iterator();
	...
	{
		final ArrayList var3 = Lists.newArrayList();
		final Iterator var4 = this.playerEntities.iterator();
	...
	{
		int var2 = 0;
		final Iterator var3 = this.loadedEntityList.iterator();
	...
	public EntityPlayer getClosestPlayer(final double x, final double y, final double z, final double distance)
	{
		...
		{
			final EntityPlayer var13 = (EntityPlayer) this.playerEntities.get(var12);
	...
	public boolean func_175636_b(final double p_175636_1_, final double p_175636_3_, final double p_175636_5_, final double p_175636_7_)
	{
		...
		{
			final EntityPlayer var10 = (EntityPlayer) this.playerEntities.get(var9);
	...
	public EntityPlayer getPlayerEntityByName(final String name)
	{
		...
		{
			final EntityPlayer var3 = (EntityPlayer) this.playerEntities.get(var2);
	...
	{
		return this.getWeightedThunderStrength(1.0F) > 0.9D;
	}
	...
	public void sendBlockBreakProgress(final int breakerId, final BlockPos pos, final int progress)
	{
		for (int var4 = 0; var4 < this.worldAccesses.size(); ++var4)
		{
			final IWorldAccess var5 = (IWorldAccess) this.worldAccesses.get(var4);

...
public class EntityList
{
	...
	private static void addMapping(final Class p_75618_0_, final String p_75618_1_, final int p_75618_2_)
	{
		...
		else
		{
			...
			completions.add(new TabCompletion(p_75618_1_));
		}
	}
	 ...
	 */
	public static Entity createEntityFromNBT(final NBTTagCompound tag, final World worldIn)
	{
		return createEntityFromNBT(tag, worldIn, tag.getString("id"));
	}
	
	public static Entity createEntityFromNBT(final NBTTagCompound tag, final World worldIn, String id)
	{
		Entity var2 = null;
		
		if ("Minecart".equals(id))
		{
			id = EntityMinecart.EnumMinecartType.func_180038_a(tag.getInteger("Type")).func_180040_b();
			tag.removeTag("Type");
		}

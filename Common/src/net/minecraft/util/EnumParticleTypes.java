...
public enum EnumParticleTypes
{
	...
	private static final Map<Integer, EnumParticleTypes> field_179365_U = new HashMap<>();
	private static final Map<String, EnumParticleTypes> stringMap = new HashMap<>();
	private static final String[] field_179368_V;
	private static final String __OBFID = "CL_00002317";
	
	private EnumParticleTypes(final String p_i46011_3_, final int p_i46011_4_, final boolean p_i46011_5_, final int p_i46011_6_)
	{
	...
	private EnumParticleTypes(final String p_i46012_3_, final int p_i46012_4_, final boolean p_i46012_5_)
	{
	...
	public static EnumParticleTypes getByName(final String name)
	{
	...
	static
	{
		final List<String> var0 = new ArrayList<>();
		
		for (final EnumParticleTypes particle : values())
		{
			field_179365_U.put(Integer.valueOf(particle.func_179348_c()), particle);
			stringMap.put(particle.func_179346_b().toLowerCase(), particle);
			
			if (!particle.func_179343_f())
				var0.add(particle.func_179346_b());
		}

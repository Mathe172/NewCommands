...
public class Scoreboard
{
	...
	{
		final Collection var2 = (Collection) this.scoreObjectiveCriterias.get(p_96520_1_);
	...
	public Map<ScoreObjective, Score> getScores(final String id)
	{
		return (Map<ScoreObjective, Score>) this.field_96544_c.get(id);
	}

...
public class ParserUntypedLabel extends CustomCompletable<ArgWrapper<?>>
{
	private final ProviderCompleter completer;
	
	public ParserUntypedLabel()
	{
	...
	@Override
	public ArgWrapper<?> iParse(final Parser parser) throws SyntaxErrorException
	{

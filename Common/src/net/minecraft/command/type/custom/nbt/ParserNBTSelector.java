...
public class ParserNBTSelector extends CustomCompletable<CommandArg<NBTBase>>
{
	...
	{
		TabCompletionData.addToSet(tcDataSet, startIndex, cData, TypeIDs.NBTBase.getSelectorCompletions());
	}
}
